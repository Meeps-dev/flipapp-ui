...
const Color kOrangeTomatoFD = Color(0xffFD6442);
const Color kBlack000 = Color(0xff000000);
const Color kGreyE3 = Color(0xffE3E3E3);
...
const double kBorderRadius100 = 100;
...
final kMuliBold = GoogleFonts.mulish(
  fontWeight: FontWeight.w700,
);

final kMuliSemibold = GoogleFonts.mulish(
  fontWeight: FontWeight.w600,
);

final kMuliMedium = GoogleFonts.mulish(
  fontWeight: FontWeight.w500,
);

final kMuliRegular = GoogleFonts.mulish(
